...
function addBodyEvents() {
    ...
    document.body.addEventListener("mouseout", function onMouseOut(e) {
        ...
        console.log(2);
        if (e.fromElement && e.fromElement.tagName === "TEXTAREA") {
            encryptTextArea(e.fromElement);
        } else if (e.toElement && e.toElement.tagName === "TEXTAREA") {
            decryptTextArea(e.toElement);
        } else if(e.toElement) {
            /*
                        $target = $(e.toElement);
            if ($target.hasClass("userContent") || /comment/.test($target.attr("id"))) {
                decryptElement(e.toElement);
            }
             */
            decryptElement(e.toElement);
        }
...
/******/ /* WEBPACK FREE VAR INJECTION */ }(require(1)))
...
if ( typeof define === "function" && define.amd && define.amd.jQuery ) {
	define( 0, [], function () { return jQuery; } );
}

})( window );

/******/ /* WEBPACK FREE VAR INJECTION */ }(require(2)(module)))
